<script>
    ...
    async function submitHandler() {
        const id = await postRole(roleName);
        if (id) {
...
>
    <button
        ...
        class="py-5 px-10 bg-red-500 text-lg font-normal rounded-md w-[20%] mb-3 flexbox justify-center cursor-pointer"
        >Zamknij</button
    >
    <button
        type="submit"
        class="py-5 px-10 bg-[#0078c8] text-lg font-normal rounded-md w-[70%] mb-3 flexbox justify-center cursor-pointer"
        >Utwórz</button
    >
