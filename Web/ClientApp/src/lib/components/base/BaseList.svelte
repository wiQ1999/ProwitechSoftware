...
<button on:click={onDeleteSelected} class="mx-auto rounded-sm w-[95%] bg-red-500 border-2 border-b-0 border-slate-600 flex justify-center">Usuń zaznaczone</button>
