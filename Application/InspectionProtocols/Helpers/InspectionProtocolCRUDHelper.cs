...
namespace Application.InspectionProtocols.Helpers
{
    public class InspectionProtocolCRUDHelper
    {
        public static void CheckIfAllAnswersAreCorrect(CreateOrUpdateInspectionProtocolDTO protocolDTO)
        {
            ...
            AnswerChecker.AnswersContain(new E02_B_Gazomierz_szafka_wentylowana(), protocolDTO.A02_B_Gazomierz_szafka_wentylowana.ToString());
            ...
            AnswerChecker.MultipleAnswersContain(new E07_M_Przewody_rodzaj(), protocolDTO.A07_M_Przewody_rodzaj);
